...
| **R6** | レイアウト | レジュメモード時 **［サムネ(任意で隠せる)｜教材・単一ページ｜レジュメ pane］**。レジュメ pane は**今の葵 chat 枠を置換** (4 ペインは狭すぎる)、葵との会話は**レジュメを育てる道具**として pane 内で起きる (上=育つレジュメ本文 / 下=葵会話＋🎤＋3 色添削)。**教材は自動で単一ページに切替** (見開き⇄単一は元から可) |
