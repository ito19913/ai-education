...
/**
 * Resizable panel コンポーネント。react-resizable-panels v4 ベース。
 * v4 で API が変更: PanelGroup → Group, PanelResizeHandle → Separator, direction → orientation。
 * shadcn 命名（ResizablePanelGroup / ResizablePanel / ResizableHandle）を維持。
 */
